...
public class UserTypeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbEmployeeName.setText("User Type");
        backgroundPanel.add(lbEmployeeName, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 80, 30));
        backgroundPanel.add(txtUserTypeName, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 200, 30));
        ...
        PatientLabel.setText("User Type");
        backgroundPanel.add(PatientLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 120, 30));
        ...
        backgroundPanel.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 115, 30));
        ...
        backgroundPanel.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 120, 30));
        ...
        backgroundPanel.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, 120, 30));
        ...
        backgroundPanel.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 110, 115, 30));

        tablePanel.setBackground(backgroundPanel.getBackground());
        tablePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true), "User Types", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        userTypeTable.setToolTipText("Patient Records");
        userTypeTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        userTypeTable.setFocusable(false);
        userTypeTable.setSelectionBackground(java.awt.Color.red);
        userTypeTable.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        userTypeTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                userTypeTableMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(userTypeTable);

        tablePanel.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 480, 210));

        backgroundPanel.add(tablePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 500, 240));

        getContentPane().add(backgroundPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 400));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if(txtUserTypeName.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Please Fill Field");
        }
        else {
            UserTypeModel userTypeModel = new UserTypeModel();
            userTypeModel.setUserType(txtUserTypeName.getText().trim());
            userTypeModel.setCreatedBy(1);
            UserTypeDAO userTypeDAO = new UserTypeDAOImpl();
            int row = userTypeDAO.addUserType(userTypeModel);
            if(row>0) {
                populateMyTable();
                txtUserTypeName.setText(null);
            }
            else {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if(txtUserTypeName.getText().trim().isEmpty()) {
            ...
            UserTypeDAO userTypeDAO = new UserTypeDAOImpl();
            int row = userTypeDAO.updateUserType(userTypeModel);
            if(row>0) {
                populateMyTable();
                txtUserTypeName.setText(null);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(confirm==0) {
            ...
            userTypeModel.setUserTypeId(userTypeId);
            UserTypeDAO userTypeDAO = new UserTypeDAOImpl();
            int row = userTypeDAO.deleteUserType(userTypeModel);
            if(row>0) {
                populateMyTable();
                txtUserTypeName.setText(null);
                btnAdd.setEnabled(true);
    ...
    private void userTypeTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTypeTableMouseClicked
        ...
        UserTypeDAO userTypeDAO = new UserTypeDAOImpl();
        UserTypeModel userTypeModel = userTypeDAO.getUserTypeWithId(userTypeId);
        txtUserTypeName.setText(userTypeModel.getUserType());
...
//    }
    ...
    private void populateMyTable() {  
        UserTypeDAO userTypeDAO = new UserTypeDAOImpl();
        ResultSet rs= userTypeDAO.getAllUserTypeResultSet();
    ...
    private void checkPermissions() {
        ...
        for (UserPermissionModel permissionModel : permissionModels) {
            if(permissionModel.getPermissionModel().getName().equals("ADD_USER_TYPE")) {
                btnAdd.setVisible(true);
            }
            if(permissionModel.getPermissionModel().getName().equals("UPDATE_USER_TYPE")) {
                btnUpdate.setVisible(true);
            }
            if(permissionModel.getPermissionModel().getName().equals("DELETE_USER_TYPE")) {
